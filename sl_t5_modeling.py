...
from shared_components_modeling import LinearAdapter, ConvAdapter


class SignLanguageT5Encoder(T5PreTrainedModel):
    ...
    def forward(
        ...
        inputs_embeds = self.adapter(input_features).permute(0, 2, 1)
...
class SignLanguageT5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def __init__(self, config: T5Config):
        ...
        self.encoder = SignLanguageT5Encoder(encoder_config)
    ...
    def generate(self, **kwargs):
        if "input_ids" not in kwargs.keys():
            kwargs["input_ids"] = kwargs["input_features"]
